    ...
    public class MainLobby : MonoBehaviourPunCallbacks
    {
        ...
        public override void OnJoinedRoom()
        {
            ...
            foreach (Player p in PhotonNetwork.PlayerList)
            {
                ...
                if (p.CustomProperties.TryGetValue(MasterManager.Instance.PLAYER_READY, out isPlayerReady))
                {
            ...
            {
                {MasterManager.Instance.PLAYER_LOADED_LEVEL, false}
            };
        ...
        public override void OnPlayerPropertiesUpdate(Player targetPlayer, Hashtable changedProps)
        {
            ...
            {
                object isPlayerReady;
                if (changedProps.TryGetValue(MasterManager.Instance.PLAYER_READY, out isPlayerReady))
                {
                    entry.GetComponent<PlayerList>().SetPlayerReady((bool) isPlayerReady);
                }
            }
