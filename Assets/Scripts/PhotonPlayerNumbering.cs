...
namespace root
{
    ...
    /// </remarks>
    public class PhotonPlayerNumbering : MonoBehaviourPunCallbacks
    {
        ...
        /// </summary>
        public static PhotonPlayerNumbering instance;
        ...
        {
            PhotonNetwork.LocalPlayer.CustomProperties.Remove(PhotonPlayerNumbering.RoomPlayerIndexedProp);
        }
        ...
        {
            if (changedProps != null && changedProps.ContainsKey(PhotonPlayerNumbering.RoomPlayerIndexedProp))
            {
                this.RefreshData();
            }
        }
    ...
    public static class PlayerNumberingExtensions
    {
        ...
        public static int GetPlayerNumber(this Player player)
        {
            ...
            object value;
			if (player.CustomProperties.TryGetValue (PhotonPlayerNumbering.RoomPlayerIndexedProp, out value)) {
				return (byte)value;
			}
            return -1;
        }
        ...
        public static void SetPlayerNumber(this Player player, int playerNumber)
        {
            ...
            if (current != playerNumber)
            {
                ...
                player.SetCustomProperties(new Hashtable() { { PhotonPlayerNumbering.RoomPlayerIndexedProp, (byte)playerNumber } });
            }
        }
    }
}